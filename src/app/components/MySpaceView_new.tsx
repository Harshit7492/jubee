  ...
  { showSortMenu && (
    <>
      ...
      <button
        ...
        className={`w-full flex items-center gap-3 px-4 py-2.5 text-sm transition-colors ${sortBy === 'name-desc' ? 'bg-[#1E3A8A]/10 text-[#1E3A8A] font-semibold' : 'text-foreground hover:bg-accent'
          }`}
      >
      ...
      <button
        ...
        className={`w-full flex items-center gap-3 px-4 py-2.5 text-sm transition-colors ${sortBy === 'date-new' ? 'bg-[#1E3A8A]/10 text-[#1E3A8A] font-semibold' : 'text-foreground hover:bg-accent'
          }`}
      >
      ...
      <button
        ...
        className={`w-full flex items-center gap-3 px-4 py-2.5 text-sm transition-colors ${sortBy === 'date-old' ? 'bg-[#1E3A8A]/10 text-[#1E3A8A] font-semibold' : 'text-foreground hover:bg-accent'
          }`}
      >
      ...
      <button
        ...
        className={`w-full flex items-center gap-3 px-4 py-2.5 text-sm transition-colors ${sortBy === 'size-large' ? 'bg-[#1E3A8A]/10 text-[#1E3A8A] font-semibold' : 'text-foreground hover:bg-accent'
          }`}
      >
      ...
      <button
        ...
        className={`w-full flex items-center gap-3 px-4 py-2.5 text-sm transition-colors ${sortBy === 'size-small' ? 'bg-[#1E3A8A]/10 text-[#1E3A8A] font-semibold' : 'text-foreground hover:bg-accent'
          }`}
      >
      ...
      <button
        ...
        className={`w-full flex items-center gap-3 px-4 py-2.5 text-sm transition-colors ${sortBy === 'type' ? 'bg-[#1E3A8A]/10 text-[#1E3A8A] font-semibold' : 'text-foreground hover:bg-accent'
          }`}
      >
  ...
  <div className=\"space-y-1 max-h-40 overflow-y-auto\">
{
  uniqueClients.map(client => (
    <button
      ...
      className={`w-full text-left px-3 py-2 rounded-lg text-sm transition-colors ${filterByClient === client
  ...
  <div className=\"space-y-1\">
{
  uniqueCategories.map(category => (
    <button
      ...
      className={`w-full text-left px-3 py-2 rounded-lg text-sm transition-colors ${filterByCategory === category
          ? 'bg-[#1E3A8A]/10 text-[#1E3A8A] font-semibold'
          : 'text-foreground hover:bg-accent'
        }`}
    >
  ...
  <div className=\"space-y-1\">
{
  uniqueStatuses.map(status => (
    <button
      ...
      className={`w-full text-left px-3 py-2 rounded-lg text-sm transition-colors ${filterByStatus === status
          ? 'bg-[#1E3A8A]/10 text-[#1E3A8A] font-semibold'
          : 'text-foreground hover:bg-accent'
        }`}
    >
  ...
  viewMode === 'grid' && filteredItems.length > 0 && (
    <>
      ...
      <button
        ...
        className={`px-3 py-1.5 rounded-lg transition-colors ${index === breadcrumbs.length - 1
            ? 'bg-[#1E3A8A]/10 text-[#1E3A8A] font-semibold'
